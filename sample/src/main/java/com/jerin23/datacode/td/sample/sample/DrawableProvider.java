...
import com.jerin23.datacode.textdrawable.util.ColorGenerator;
import com.jerin23.datacode.textdrawable.TextoDrawable;
...
public class DrawableProvider {
    ...
    public TextoDrawable getRect(String text) {
        return TextoDrawable.builder()
                .buildRect(text, mGenerator.getColor(text));
    }

    public TextoDrawable getRound(String text) {
        return TextoDrawable.builder()
                .buildRound(text, mGenerator.getColor(text));
    }

    public TextoDrawable getRoundRect(String text) {
        return TextoDrawable.builder()
                .buildRoundRect(text, mGenerator.getColor(text), toPx(10));
    }

    public TextoDrawable getRectWithBorder(String text) {
        return TextoDrawable.builder()
                .beginConfig()
                .withBorder(toPx(2))
                .endConfig()
    ...
    public TextoDrawable getRoundWithBorder(String text) {
        return TextoDrawable.builder()
                .beginConfig()
                .withBorder(toPx(2))
                .endConfig()
    ...
    public TextoDrawable getRoundRectWithBorder(String text) {
        return TextoDrawable.builder()
                .beginConfig()
                .withBorder(toPx(2))
                .endConfig()
    ...
    public TextoDrawable getRectWithMultiLetter() {
        String text = "AK";
        return TextoDrawable.builder()
                .beginConfig()
                .fontSize(toPx(20))
    ...
    public TextoDrawable getRoundWithCustomFont() {
        String text = "Bold";
        return TextoDrawable.builder()
                .beginConfig()
    ...
    public Drawable getRectWithCustomSize() {
        ...
        TextoDrawable.IBuilder builder = TextoDrawable.builder()
                .beginConfig()
                .width(toPx(29))
                .withBorder(toPx(2))
                .endConfig()
        ...
        TextoDrawable left = builder
                .build(leftText, mGenerator.getColor(leftText));

        TextoDrawable right = builder
    ...
    public Drawable getRectWithAnimation() {
        ...
        for (int i = 10; i > 0; i--) {
            TextoDrawable frame = builder.build(String.valueOf(i), mGenerator.getRandomColor());
