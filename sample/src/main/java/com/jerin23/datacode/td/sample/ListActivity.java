package com.jerin23.datacode.td.sample;
...
import com.jerin23.datacode.td.R;
import com.jerin23.datacode.td.sample.sample.DrawableProvider;
...
public class ListActivity extends ActionBarActivity {
    ...
    private TextoDrawable.IBuilder mDrawableBuilder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (type) {
            case DrawableProvider.SAMPLE_RECT:
                mDrawableBuilder = TextoDrawable.builder()
                        .rect();
                break;
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        private void updateCheckedState(ViewHolder holder, ListData item) {
            if (item.isChecked) {
                ...
                TextoDrawable drawable = mDrawableBuilder.build(String.valueOf(item.data.charAt(0)), mColorGenerator.getColor(item.data));
